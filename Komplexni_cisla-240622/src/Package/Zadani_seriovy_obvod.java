...
public class Zadani_seriovy_obvod implements ActionListener{
	...
	public Zadani_seriovy_obvod(){

		ulozit_zadani = new JButton("Submit");
		ulozit_zadani.addActionListener(this);
		ulozit_zadani.setSize(1920,120);
		
		JOptionPane.showMessageDialog(null, "Zapište hodnoty (i=imaginární, r=reálná) pro sériové zapojení obvodu", "Zadání pro sériové zapojení obvodu",JOptionPane.INFORMATION_MESSAGE);
		
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.setLayout(new GridLayout(7,4));
		frame.setTitle("Zapište hodnoty (i=imaginární, r=reálná) pro sériové zapojení obvodu");
