...
public class Vypocet{
	...
	public Vypocet(){
		...
		vysledek_I.setText("Výsledek I: "+Zadani_seriovy_obvod.rI+" + "+Zadani_seriovy_obvod.iI+" j");
		...
		vysledek_S.setText("Výsledek S: "+Zadani_seriovy_obvod.rS+" + "+Zadani_seriovy_obvod.iS+" j");
		...
		vysledek_P.setText("Výsledek P: "+Zadani_seriovy_obvod.P);
		...
		if(Zadani_seriovy_obvod.hodnota_Xc.equals(null)){
			vysledek_Xc.setText("Xc: "+(1/(2*PI*Zadani_seriovy_obvod.f*Zadani_seriovy_obvod.C*(1/1000000))));
		}
		else{
			vysledek_Xc.setText("Xc: "+Zadani_seriovy_obvod.Xc);
		}
